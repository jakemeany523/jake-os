...
rubric: social-post
version: 2026-04-09
applies_to: Twitter/X and LinkedIn posts (Jake first-person voice)
threshold: 7.5
---

# Social Post Rubric (house)
...
### 2. voice_fit
Does it sound like Jake? First-person ("I ran", "I put"), direct, slightly irreverent, no hedging, no corporate "we," no AI tells. Profile reference: `memory/reference/profiles/house.md`. Banned phrases in `copy-reviewer` SKILL.md trigger automatic cap at 4.
