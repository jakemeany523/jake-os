...
**What:** Python script that generates properly tagged UTM links for all social posts, newsletters, and influencer content. Enforces consistent parameter values so attribution data in Mixpanel is clean and queryable.
...
- `utm_campaign=eval-drop` tells you benchmark content drove 40 sign-ups this month
...
Twitter benchmark drop:
  https://example.com?utm_source=twitter&utm_medium=social&utm_campaign=eval-drop&utm_content=0310

Twitter thesis post:
  https://example.com?utm_source=twitter&utm_medium=social&utm_campaign=narrative&utm_content=0310

Twitter product demo:
  https://example.com?utm_source=twitter&utm_medium=social&utm_campaign=demo&utm_content=0310
...
```
...
Every example.com link that goes into a post, tweet, newsletter, or influencer brief should have UTM parameters. No exceptions. The generator enforces consistent parameter spelling so data is clean.

**Wrong:** `https://example.com/benchmarks`
**Right:** `https://example.com/benchmarks?utm_source=twitter&utm_medium=social&utm_campaign=eval-drop&utm_content=0310-launch`
...
utm_content=0310-[creator-handle]
```
