...
The core content creation skill. Pulls live evaluation data from the platform, generates branded data visualizations, drafts platform-native copy, and runs every draft through the Copy Reviewer before delivery.

## Workflow

1. Read learning memory for accumulated preferences and patterns
2. Check the platform for fresh evaluation data worth highlighting
...
- **Platform SDK:** Pulls model evaluations, benchmark results, SOTA data
...
Data-heavy posts now auto-trigger branded video rendering via the Data Video skill:
