...
When new evaluation data lands in the platform, this skill automates the full eval-drop pipeline: pull data, identify SOTA results and regressions, generate branded comparison charts, and produce publish-ready social copy.

## Workflow

1. Pull evaluation data from the platform SDK
...
- **Platform SDK:** Primary data source
