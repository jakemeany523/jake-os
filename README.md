...
I'm the solo marketer at [the company](https://example.com), an AI evaluation infrastructure company. Content, social, SEO, AEO, influencer, brand. All one person.
...
| **Operations** | Branded Doc Generator, the company Graphics, System Sweep |
...
| the CRM MCP | TypeScript | CRM access for deal tracking and contact management |
