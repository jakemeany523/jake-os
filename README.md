...
| **Social Drafter** | 7:30 AM daily | Reads morning brief context and reactive intel from the day before. Scouts the platform evaluations. Creates branded data visualizations. Drafts Twitter/X and LinkedIn posts. Runs every draft through the Copy Reviewer skill. Delivers a ready-to-publish package. |
...
| Skill | What It Does |
|-------|-------------|
| **Social Content Drafter** | Drafts publish-ready social content for Twitter/X and LinkedIn with copy-reviewer rules baked into generation, live the platform data integration, branded graphics, and narrative alignment. The core content creation skill. |
...
| **Benchmark Drop** | Automates eval-drop workflow: pulls the platform evaluation data, identifies SOTA results and regressions, generates publish-ready social copy and branded PNG comparison charts. |
...
| Skill | What It Does |
|-------|-------------|
| **Meeting Prep Generator** | Auto-generates meeting prep briefs by pulling CRM data (the CRM), email history, Fireflies transcripts, and calendar context. Outputs a 2-minute actionable brief with attendee context, deal status, last interactions, and talking points. |
...
memory/
  ...
  reference/             # Stable reference material
    ...
    platform-sdk.md       # SDK methods and fields
...
- **Integration access:** How to connect to the platform, the CRM, and other tools
...
| CRM | the CRM via MCP connector | Existing subscription |
...
- **CRM integration:** Added the CRM MCP for deal tracking, meeting prep, and post-meeting processing
...
jake-os/
  ...
  skills/
    ...
    eval-drop/           # Benchmark release content workflow
...
**Tools used to build this:** Claude Code, Claude Cowork, Python, TypeScript, MCP (Model Context Protocol), Ahrefs API, Fireflies GraphQL API, Twitter API, Telegram Bot API, the CRM, Notion, Slack, Google Calendar, Google Analytics 4.
